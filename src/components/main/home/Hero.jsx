  ...
  return (
    ...
    >
      <div className="flex flex-col items-center md:items-start text-center md:text-left gap-3 ml-0 md:ml-10 py-8">
        <h1 className="text-[27px] leading-[27px] md:text-[25px] md:text-[25px] lg:text-[30px] lg:leading-[30px] font-bold">
          {t("title")}
        </h1>
        <p
          className="w-full max-w-2xl text-[34px] leading-[40px] md:text-[55px] md:text-[55px] 
